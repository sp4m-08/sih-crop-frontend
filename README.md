...
- `frontend`: React (Vite + TypeScript) single‑page app for Authentication, Chat, and Farmer Profile pages
- `sih`: Node.js/Express API with MongoDB for auth, profiles, sessions, and conversations
